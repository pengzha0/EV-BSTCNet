...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, relu_type='relu', gamma_zero=False, avg_pool_downsample=False, video_3D=None):
        self.inplanes = 64
    ...
    def forward(self, x):
        ...
        x = x.view(x.size(0), -1)
        x = x.reshape(B, L, 512)
        # print(video_feature.shape)# torch.Size([6, 40, 512])
